  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute top-0 left-0 w-full h-full bg-[linear-gradient(to_right,hsla(220,13%,0%,0.3)_40%,hsla(220,13%,0%,1)_80%)]  transition-opacity duration-800 ease-(--ease) z50 will-change-[opacity] ${open ? "opacity-100" : "opacity-0"}`}
      />
