  ...
  return (
    <>
      <div className="transition-container fixed inset-0 z-200 pointer-events-none">
        ...
        <div className="transition-logo text-(--color-dark) flex flex-col justify-center items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <p className="">portfolio by</p>
          <h1 className="text-[calc(clamp(3.25em,7vw,8em)*.275)] leading-[1.06] tracking-[-0.02em] ">
            Aryan Kumar
          </h1>
